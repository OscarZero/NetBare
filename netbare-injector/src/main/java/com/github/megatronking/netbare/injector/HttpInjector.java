...
public interface HttpInjector {
    ...
    void intercept(HttpResponse response,  ByteBuffer buffer, int index,String content);
    void intercept(HttpRequest request,  ByteBuffer buffer, int index,String content);
