...
public final class DefaultVirtualGatewayFactory implements VirtualGatewayFactory {
    ...
    private DefaultVirtualGatewayFactory(@NonNull List<InterceptorFactory<Request, RequestChain,Response, ResponseChain>> factories) {
//        InterceptorFactory ll = new HttpInterceptorFactory() {
//            @NonNull
//            @Override
